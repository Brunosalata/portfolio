<template>
  <h1 class="mb-2 text-md-h3">Be there from anywhere</h1>
  <div>
    <Carousel />
  </div>
  <div class="pa-5 pt-0">
  ...
  <div class="bg-grey-darken-4 d-flex justify-center align-center">
    <div style="padding-top: 80px; width: 90%;">
      <div class="text-yellow-darken-1" flex style="padding-left: 2%;">
        <h1>Atributos</h1>
      </div>
      ...
      <v-divider></v-divider>
      <div class="pt-15">
        <div class="mb-10 text-yellow-darken-1 d-flex justify-center align-center">
          <h1>Tecnologias</h1>
        </div>
      </div>
    </div>
